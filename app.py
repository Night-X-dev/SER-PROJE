...
@app.route('/ik_settings')
def ik_settings_page():
    """Directs /ik_settings.html requests to the ik_settings.html page."""
    return render_template('ik_settings.html')
@app.route('/ik_izinlerim')
